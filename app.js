  ...
  accessories: [
    {
      ...
      images: ["image/Suede Baseball Cap/DARK CHOCOLATE BROWN/1.png", "image/Suede Baseball Cap/DARK CHOCOLATE BROWN/2.png", "image/Suede Baseball Cap/DEEP TEAL/1.png", "image/Suede Baseball Cap/DEEP TEAL/2.png", "image/Suede Baseball Cap/DEEP TEAL/3.png", "image/Suede Baseball Cap/DEEP TEAL/4.png", "image/Suede Baseball Cap/DEEP TEAL/5.png"],
      colors: ["DARK CHOCOLATE BROWN", "DEEP TEAL"],
      description: "Premium suede baseball cap with a structured yet soft shape. Tonal MR embroidered logo at the front, curved brim, stitched ventilation eyelets, and adjustable back strap. Designed as a luxury casual accessory."
    }
  ]
};
      ...
      <div class="product-gallery">
        <div class="gallery-main">
          ...
          <div class="image-counter">
            <span id="imageCounter">1</span> / <span>${product.images.length}</span>
          </div>
        </div>
      </div>
...
function decreaseCartItemQuantity(cartItemId) {
  const item = cart.find(i => i.cartItemId === cartItemId);
  if (item && item.quantity > 1) updateQuantity(cartItemId, item.quantity - 1);
}

function updateCartItemQuantity(cartItemId, quantity) {
  updateQuantity(cartItemId, parseInt(quantity) || 1);
}
